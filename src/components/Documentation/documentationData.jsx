const documentationData = [
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        illustration: './assets/images_doc/paleontologues/William_Buckland.jpg',
      ...
      },
      {
        ...
        illustration: './assets/images_doc/paleontologues/Richard_Owen.jpeg',
      ...
      },
      {
        ...
        illustration: './assets/images_doc/paleontologues/Gideon_Mantell.jpg',
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        notion: 'Big Al',
        explications:
          "Découvert en 1991, ce squelette du dinosaure (nommé Allosaurus jimmadseni en 2020) a été retrouvé complet à 95%. <br /><br /> Mesurant 8 mètres de long, il est possible que ce dinosaure n'ait pas atteint sa taille adulte au moment de sa mort. <br /><br />Le squelette présente 19 os brisés ou montrant des signes d’infection qui pourrait avoir contribué à sa mort. <br /><br /> Parmi les os atteints se trouvent cinq côtes, cinq vertèbres et quatre os du pied; plusieurs os endommagés montrent des signes d’ostéomyélite, une infection osseuse dûe à une bactérie présente de le sang et s'attaquant aux os longs. L’animal était probablement très gêné par l’infection au pied droit pour marcher et cela a peut-être aussi prédisposé l’autre pied à des blessures. <br /><br /> Les os brisés peuvent être dû à des bagarres entre congénères ou causées par des proies se défendant contre Big Al. <br /><br /> Big Al a droit à un documentaire produit par la BBC.",
      ...
      },
      {
        ...
        explications:
          "C'est dans une carrière de l'Angleterre de 1676 qu'a été découvert le premier os appartenant à un dinosaure. Envoyé au conservateur Robert Plot, l'os trouvé était considéré comme un fossile d'un géant baptisé 'Scrotum Humanum' et fut le premier fossile de dinosaure à être dessiné dans la publications 'Histoire naturelle du comté d'Oxford', sans toutefois savoir qui s'agit là d'un dinosaure. <br /><br /> C'est seulement en 1824 que le paléontologue William Buckland identifia l'os en question comme celui d'une espèce disparue de reptile qui sera appelée plus tard 'Megalosaurus'. <br /><br /> En combinant les recherches de plusieurs paléontologues avant lui, tel que Georges Cuvier, Buckland rassembla plusieurs os longs, des vertèbres et une mâchoire arborant encore plusieurs dents comprimées et tranchantes trouvés dans les carrières. Buckland suppose que les os qu'il a rassemblés ont appartenu à un lézard géant éteint. Il reçoit la visite de Cuvier en 1818 et lui montre les os énormes qu'il collectionne. En 1824, Buckland donne à l'animal disparu le nom scientifique 'Megalosaurus'. <br /><br /> Dans les années 1830, on imagine Megalosaurus comme une sorte de lézard géant d'environ 30 mètres de long et on le représente avec des pattes courtes, marchant avec le ventre au ras du sol. <br /><br /> Durant les années 1840 et sous l'influence du paléontologue Richad Owen, la conception du Megalosaurus, et des dinosaures en général, change : on commence à les représenter non plus avec des pattes courbées et écartées de chaque côté du ventre comme celles des lézards et des crocodiles, mais avec des membres verticaux sous le corps, ce qui redresse nettement leur silhouette. <br /><br /> En 2016, aucun squelette complet de Megalosaurus n'a encore été retrouvé; aucun fossile notable du crâne de Megalosaurus n'est venu compléter ce que Buckland avait déjà décrit de cette partie de son squelette.",
...

  {
    ...
    data: [
      ...
      {
        notion: 'Empreintes du paléodésert de Botucatu',
        explications:
          'La formation de Botucatu est située près de Sao Paulo, au Brésil. Cette formation géologique est réputée pour ses vastes étendues de grès qui ont conservé des empreintes fossiles, notamment celles de dinosaures, de mammifères et d’autres tétrapodes. <br /><br /> Datant du Crétacé inférieur, soit il y a environ 135 millions d’années, cette formation géologique offre un aperçu fascinant de la vie animale de cette époque dans la région. Elle couvrait à l’origine une vaste étendue estimée à au moins 1,3 million de km², formant ainsi le plus grand désert fossile connu de l’histoire de la Terre.<br /><br /> L’étude de ces empreintes fossiles permet aux chercheurs de mieux comprendre la diversité des tétrapodes et les conditions environnementales qui prévalaient dans la région à l’époque du Crétacé inférieur. La découverte récente de nouvelles traces imprimées dans le sol par un petit dinosaure carnivore ajoute ainsi une nouvelle pièce au puzzle de la paléontologie de cette région et de cette période. <br /><br /> Les empreintes laissées par ce dinosaure sont distinctes de toutes les autres traces de théropodes connues. Elles représentent un nouvel ichnogenre (type d’empreinte) et une nouvelle ichnoespèce (espèce identifiée par des empreintes fossiles). L’animal, nommé Farlowichnus rapidus, était un carnivore de petite taille, mesurant environ 1,5 mètre de long. Farlowichnus rapidus possède des caractéristiques uniques, dont un angle de pas très élevé. Il s’agit de l’angle formé par la trajectoire des empreintes de pas par rapport à une ligne médiane imaginaire. Un angle de pas élevé signifie que les empreintes sont inclinées par rapport à cette ligne médiane. Les chercheurs ont également relevé des foulées longues. Autrement dit, ce dinosaure se déplaçait avec de grandes enjambées entre chaque pas.<br /><br /> Enfin, l’examen de ces empreintes a permis de relever une largeur de voie interne et externe très étroite. Notez que la voie fait référence à la distance latérale entre les empreintes gauche et droite. Une largeur de voie étroite signifie que les empreintes du dinosaure étaient rapprochées, que ce soit du côté interne (plus proche de la ligne médiane) ou externe (plus éloignée de la ligne médiane).<br /><br /> Les empreintes sont également presque parallèles ou légèrement divergentes par rapport à la ligne médiane et aucune marque de queue ou traînée n’est visible.<br /><br /> Autrement dit, ces caractéristiques suggèrent que Farlowichnus rapidus était un dinosaure rapide qui se déplaçait avec des pas presque parallèles, couvrant de grandes distances à chaque foulée, et dont les empreintes étaient rapprochées latéralement. Ces détails aident les chercheurs à reconstruire le comportement et la locomotion de l’animal dans son environnement préhistorique.',
        illustration: './assets/images_doc/decouvertes/empreintes_botucatu.jpg',
        alt: 'Empreintes du paléodésert de Botucatu',
      },

      {
        notion: 'Mosasaure à langue fourchue',
        explications:
        ...
        illustration: './assets/images_doc/decouvertes/Yaguarasaurus_regiomontanus.jpg',
        alt: 'Yaguarasaurus_regiomontanus.jpg',
      },

      {
        notion: 'Un tyrannosaure retrouvé fossilisé avec son dernier repas',
        explications:
          "Des scientifiques ont découvert pour la première fois une proie dans l’estomac d’un squelette de tyrannosaure. Le jeune animal devait avoir 7 ans et peser 330 kilogrammes. Il s'agit d'un théropode du groupe des gorgosaures, lui-même faisant partie de la famille des tyranosaures. À cet âge, il est considéré comme adolescent dans son développement.<br /><br /> Son dernier repas semble être deux bébés dinosaures, parfaitement conservé dans son estomac : Les membres postérieurs de deux petits dinosaures ressemblant à des oiseaux, appelés Citipes, sont visibles sous sa cage thoracique. <br /><br /> Cela prouve que les tyrannosaures changeaient radicalement de régime alimentaire en passant à l’âge adulte : ils savent désormais chasser, plutôt que d'attendre que ce soit les parents qui les nourrissent.",
        // illustration: './assets/images_doc/decouvertes/Yaguarasaurus_regiomontanus.jpg',
        // alt: 'Yaguarasaurus_regiomontanus.jpg',
      },
    ],

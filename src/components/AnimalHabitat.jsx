...
const AnimalHabitat = ({ animal }) => {
  ...
  return (
    <main className="habitat-section">
      <section className="habitat-header">
      ...
      <section className="habitat-info">
        <div className="info-card">
          <h4>🌋 Contexte géologique</h4>
          <p>
            Durant la période <strong>{geologie.periode || 'préhistorique'}</strong>, notre planète ne ressemblait pas à
            ce que nous connaissons aujourd'hui. Les continents étaient disposés différemment et le climat était unique.
          </p>
        </div>
        <div className="info-card">
